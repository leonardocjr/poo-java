 ...
 * @author leona
 */
public class EditPasseio extends javax.swing.JFrame {

    private Passeio p = new Passeio();
    /**
     * Creates new form cadVeic
     */
    static EditPasseio cadPasseio_unico;
    ...
    public static EditPasseio getEditPasseio(){
        if(cadPasseio_unico == null)
            cadPasseio_unico = new EditPasseio();
    ...
    private void initComponents() {
        ...
        lbTitulo.setText("Editar veículo de passeio");
    ...
    public void editPasseio(){
        ...
        p = BancoVeic.getBancoVeic().altPasseio(p);
        JOptionPane.showMessageDialog(
                null,
                "Veiculo de Passeio EDITADO com sucesso!",
    ...
    public void carrDados(){
        p = new Passeio();
        p.setPlaca(Principal.getPlacaTxt());
        cxPlaca.setText(p.getPlaca());
        p = BancoVeic.getBancoVeic().consPasseioPlaca(p);
        cxMarca.setText(p.getPlaca());
        cxModelo.setText(p.getModelo());
        cxCor.setText(p.getCor());
        cxQtdRodas.setValue(p.getQtdRodas());
        cxPotencia.setValue(p.getMotor().getPotencia());
        cxQtdPistoes.setValue(p.getMotor().getQtdPistoes());
        cxVelocMax.setValue(p.getVelocMax());
        cxQtdPass.setValue(p.getQtdePassageiro());
    }
    public void limpar(){
		cxMarca.setText("");
                cxModelo.setText("");
