 ...
 * @author leona
 */
public class EditCarga extends javax.swing.JFrame {

    private Carga c = new Carga();
    /**
     * Creates new form cadVeic
     */
    static EditCarga cadCarga_unico;
    ...
    public static EditCarga getEditCarga(){
        if(cadCarga_unico == null)
            cadCarga_unico = new EditCarga();
    ...
    private void initComponents() {
        ...
        lbTitulo.setText("Editar veículo de carga");
    ...
    public void editCarga(){
        ...
        c = BancoVeic.getBancoVeic().altCarga(c);
        JOptionPane.showMessageDialog(
                null,
                "Veiculo de Carga EDITADO com sucesso!",
    ...
    public void carrDados(){
        c = new Carga();
        c.setPlaca(Principal.getPlacaTxt());
        cxPlaca.setText(c.getPlaca());
        c = BancoVeic.getBancoVeic().consCargaPlaca(c);
        cxMarca.setText(c.getPlaca());
        cxModelo.setText(c.getModelo());
        cxCor.setText(c.getCor());
        cxQtdRodas.setValue(c.getQtdRodas());
        cxPotencia.setValue(c.getMotor().getPotencia());
        cxQtdPistoes.setValue(c.getMotor().getQtdPistoes());
        cxVelocMax.setValue(c.getVelocMax());
        cxTara.setValue(c.getTara());
        cxCargaMax.setValue(c.getCargaMax());
    }
    public void limpar(){
		cxMarca.setText("");
                cxModelo.setText("");
