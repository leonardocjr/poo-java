...
public class Maths1 {
	public static void main(String arg[]){
		...
		System.out.println("\nO valor arredondado da var 'g'(1.34) eh: " + Math.round(g));
		System.out.println("\nO valor arredondado para cima da var 'g'(1.34) eh: " + Math.ceil(g));
		System.out.println("\nO valor arredondado para baixo da var 'g'(1.34) eh: " + Math.floor(g));
		System.out.println("\nA raiz da var 'h' eh: " + Math.sqrt(h));
		System.out.println("\nA var 'f' elevada a var 'h' eh: " + Math.pow(f,h));
		System.out.println("\nO valor absoluto da var 'g'(1.34) eh: " + Math.abs(g));
